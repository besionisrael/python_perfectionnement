...
def main():
    ...
    doc = etree.fromstring(result.content) #result.content gives bytes content
    print(doc.tag)
    ...
    itemCount2 = len(doc.findall("item"))
    ...
    print("There were {0} item2 elements".format(itemCount2))
